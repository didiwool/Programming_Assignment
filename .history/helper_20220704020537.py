...
def test_data_for_count(dataframe, nearby, sensor_id, start_time, end_time, day):
    """
...
def diff_conclusion(e_distance):
    """
    ...
    print(
        "Day with the most change is " + str(max_day) +
        ", and the greatest change is " + str(round(max_change)) + ".")
    print(
