...
def modelForCount(df, sensor_id, start_time, end_time):
    ...
    (rain_prev, solar_prev, temp_prev, sensor3_past1, nearby_past1, sensor3_pastday) = dataForCount(df, nearby, sensor_id, start_time, end_time)
    ...
    # compute test data
    for day in WEEK:
        (rain_prev, solar_prev, temp_prev, sensor3_past1, nearby_past1, sensor3_pastday) = testdataForCount(df, nearby, sensor_id, start_time, end_time, day)
