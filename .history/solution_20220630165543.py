...
# the generalized function of question 2
def pedestrianScatter(df, year1, year2, x_axis):
    ...
    daily_overall_2021.plot.scatter(x = x_axis, y = "Hourly_Counts", title = "Maximum temperature vs pedestrian in 2021")
    plt.savefig('2021_scatter_temp.png')

    daily_overall_2022.plot.scatter(x = x_axis, y = "Hourly_Counts", title = "Maximum temperature vs pedestrian in 2022")
    plt.savefig('2022_scatter_temp.png')